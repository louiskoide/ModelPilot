...
//   7. --claude-bin <absolute path> (before --) runs that exact Claude Code instead of the first on PATH.
// The routing policy, prompt extraction, tier rewrite and catalog discovery are Jev's own code.
//
// Usage: node jev_accounted_launch.mjs <jev-root> <modelpilot-proxy-url> [--claude-bin <path>] -- <claude args...>
